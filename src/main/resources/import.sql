...
INSERT INTO personne(typePersonne,numero,prenom,nom,email,password) VALUES('Client',4,'jean','Phil','jp@gmail.com','pwd');
...
INSERT INTO compte(numero,label,solde,numClient) VALUES(3,'compte 3',60.0,4);
